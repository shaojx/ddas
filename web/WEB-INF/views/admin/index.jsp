...
<head>
	...
	<!--[if lt IE 9]>
	<script src="<%=path%>/common/pixel-admin/js/ie.min.js"></script>
	<![endif]-->
</head>
...
<!-- Demo script --> <script src="<%=path%>/common/pixel-admin/demo/demo.js"></script> <!-- / Demo script -->
		...
		<div class="navbar-inner">
			...
			<div class="navbar-header">
				...
				<a href="index.html" class="navbar-brand">
					<div><img alt="Pixel Admin" src="<%=path%>/common/pixel-admin/images/pixel-admin/main-navbar-logo.png"></div>
					PixelAdmin
				</a>
				...
				<div class="panel panel-warning" id="dashboard-recent">
					...
					<div class="tab-content">
						...
						<div class="widget-comments panel-body tab-pane no-padding fade active in" id="dashboard-recent-comments">
							...
							<div class="panel-padding no-padding-vr">
								<div class="comment">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/5.jpg" alt="" class="comment-avatar">
								...
								<div class="comment">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/3.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
								...
								<div class="comment">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/2.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
								...
								<div class="comment">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/4.jpg" alt="" class="comment-avatar">
									<div class="comment-body">
										<div class="comment-by">
						...
						<div class="widget-threads panel-body tab-pane no-padding fade" id="dashboard-recent-threads">
							<div class="panel-padding no-padding-vr">
								<div class="thread">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/2.jpg" alt="" class="thread-avatar">
								...
								<div class="thread">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/3.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
								...
								<div class="thread">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/4.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
								...
								<div class="thread">
									<img src="<%=path%>/common/pixel-admin/demo/avatars/5.jpg" alt="" class="thread-avatar">
									<div class="thread-body">
										<span class="thread-time">14h</span>
										<a href="#" class="thread-title">Lorem ipsum dolor sit amet</a>
				...
				<div class="panel panel-dark panel-light-green">
					...
					<table class="table">
						...
						<tr>
							<td>1</td>
							<td>
								<img src="<%=path%>/common/pixel-admin/demo/avatars/2.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@rjang</a>
							</td>
							<td>Robert Jang</td>
						...
						<tr>
							<td>2</td>
							<td>
								<img src="<%=path%>/common/pixel-admin/demo/avatars/3.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@mbortz</a>
							</td>
						...
						<tr>
							<td>3</td>
							<td>
								<img src="<%=path%>/common/pixel-admin/demo/avatars/4.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@towens</a>
							</td>
							<td>Timothy Owens</td>
						...
						<tr>
							<td>4</td>
							<td>
								<img src="<%=path%>/common/pixel-admin/demo/avatars/5.jpg" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@dsteiner</a>
							</td>
